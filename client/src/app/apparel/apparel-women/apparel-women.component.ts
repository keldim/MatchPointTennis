...
@Component({
  selector: 'app-apparel-women',
  templateUrl: './apparel-women.component.html',
  styleUrls: ['./apparel-women.component.css']
})
export class ApparelWomenComponent implements OnInit {
  ...
  colorFilter: any;
  priceFilter: any;
  apparelFilter: any = this.storageService.getWomenApparelFilter();

  constructor(private storageService: StorageService) {
    this.storageService.watchWomenApparelFilter().subscribe(apparelFilter => {
      this.apparelFilter = apparelFilter;
    });
  }

  ngOnInit() {
    this.filteredProducts = [...this.womenApparel.apparelList];
  ...
  performFilter() {
    ...
    let temporaryList: any[] = [...this.womenApparel.apparelList];
